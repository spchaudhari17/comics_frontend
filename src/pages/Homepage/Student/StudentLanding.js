...
const StudentLanding = () => {
  return (
    <div className="ForStudent-Page py-4">
          ...
          <div className="d-flex flex-column gap-3">
            <div className="info-wrapper bg-theme1 border rounded-4 px-3 px-md-4 py-4">
              ...
              <ul className="list-disc mb-3">
                <li className="mb-2">Comic-style lessons with storylines and characters.</li>
            ...
            <div className="info-wrapper bg-theme1 border rounded-4 px-3 px-md-4 py-4">
              ...
              <ul className="list-disc mb-3">
                <li className="mb-2">Campaign Mode: Subject-wise lessons presented in story arcs.</li>
                <li>Short-form Mode: TikTok-style videos with embedded quick quizzes.</li>
              </ul>
            </div>
            <div className="info-wrapper bg-theme1 border rounded-4 px-3 px-md-4 py-4">
              <div className="fs-16 fw-bold text-theme4 mb-2">3. Real-Time 1v1 Quiz Battles</div>
              <ul className="list-disc mb-3">
                <li className="mb-2">Multiplayer quiz duels using earned energy points.</li>
            ...
            <div className="info-wrapper bg-theme1 border rounded-4 px-3 px-md-4 py-4">
              ...
              <ul className="list-disc mb-3">
                <li className="mb-2">Earn coins, gems, and energy points.</li>
                <li>Unlock:
                  <ul>
            ...
            <div className="info-wrapper bg-theme1 border rounded-4 px-3 px-md-4 py-4">
              ...
              <ul className="list-disc mb-3">
                <li className="mb-2">Post-quiz challenges to double rewards.</li>
